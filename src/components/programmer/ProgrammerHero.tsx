...
export function ProgrammerHero() {
  ...
  return (
    <section
      id="hero"
      className="programmer-panel panel-sunset flex h-dvh w-full shrink-0 flex-row flex-wrap items-center justify-center gap-4 overflow-y-auto px-(--spacing-gutter) pt-14 sm:gap-6 sm:px-10 sm:pt-28 lg:flex-nowrap lg:items-stretch lg:justify-between lg:gap-12"
    >
      <div className="order-2 flex min-w-0 flex-col items-start gap-2 sm:gap-6 lg:order-none lg:self-center">
      ...
      <div className="hero-glitch hero-portrait order-1 relative h-[30.72rem] w-[28.16rem] max-w-full shrink-0 self-end sm:h-[43.2rem] sm:w-xl lg:order-none lg:h-[57.6rem] lg:w-[46.8rem]">
        <Image
