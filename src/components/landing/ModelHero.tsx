  ...
  return (
    ...
    >
      <div className="w-full max-w-[340px] lg:mr-4">
        ...
        <span className="flex items-center text-3xl font-extrabold tracking-tight text-[#ea580c] transition-transform duration-200 group-hover:translate-x-1.5 sm:text-4xl md:text-5xl lg:text-neutral-900">
          {t('model.headline')}
        </span>
      </div>
    </Link>
